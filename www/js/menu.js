	...
	var panel = '<div data-position="right" id="nav-panel" data-theme="b" data-display="push" data-role="panel" class="ui-panel ui-panel-position-right ui-panel-display-push ui-body-b ui-panel-animate ui-panel-open"><div class="ui-panel-inner"><ul class="ui-listview" data-role="listview">';
		...
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=403'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/02-register2.png">ثبت نام پکیج های آمادگی آزمون رزیدنتی</a></li>';
		panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=120'" + ',true,false);" class="odd ui-btn ui-btn-icon-right ui-icon-carat-r" data-rel="external" data-ajax="false"><img src="images/menu/03-content.png">پکیج درک مفاهیم رفرنس اصلی</a></li>';
		...
		panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=230'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">محتوای دروس مرور سریع</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=231'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/08-register.png">پکیج های آموزشی کلینیکال</a></li>';
		panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=232'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/09-video.png">فیلم های آموزشی رایگان</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_content&view=category&id=120&Itemid=233'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/10-nashriat2.png">آرشیو نشریات</a></li>';
		
		panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_blankcomponent&view=default&Itemid=542'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">محتوای زبان انگلیسی</a></li>';
		...
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.com/index.php?option=com_myacademy&view=notificationqueues&Itemid=424'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/01-news.png">اطلاعیه های پارسه</a></li>';
