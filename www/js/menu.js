	...
	var panel = '<div data-position="right" id="nav-panel" data-theme="b" data-display="push" data-role="panel" class="ui-panel ui-panel-position-right ui-panel-display-push ui-body-b ui-panel-animate ui-panel-open"><div class="ui-panel-inner"><ul class="ui-listview" data-role="listview">';
		...
		//panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=959'" + ',true,false);" class="odd ui-btn ui-btn-icon-right ui-icon-carat-r" data-rel="external" data-ajax="false"><img src="images/menu/03-content.png">محتوای پکیج درک مفاهیم کتب ملی</a></li>';
		//panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=227'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/04-moshavereh2.png">مشاوره و برنامه ریزی</a></li>';
		// panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=228'" + ',true,false);" class="odd ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/05-register.png">ثبت نام آزمون ها</a></li>';
		// panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=229'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/06-azmoon2.png">محتوای سؤالات ورودی و بورد</a></li>';
		// panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=544'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">دستیار کنار دندانپزشک</a></li>';
		// panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL('  + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=528'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/01-newp.png">باشگاه دانش آموختگان</a></li>';

	
		panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=120'" + ',true,false);" class="odd ui-btn ui-btn-icon-right ui-icon-carat-r" data-rel="external" data-ajax="false"><img src="images/menu/03-content.png">محتوا پکیج بررسی و درک مفاهیم</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=231'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/08-register.png">معرفی پکیج های آموزشی کلینیکال</a></li>';
		panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL('  + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=227'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/01-newp.png">مشاوره و برنامه ریزی</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=403'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/02-register2.png">معرفی پکیج های آمادگی آزمون رزیدنتی</a></li>';
		panel = panel + '<li class="even ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=230'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">محتوای خلاصه و جمع بندی (مرور سریع)</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=542'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">محتوای پکیج زبان انگلیسی</a></li>';
		panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_content&view=category&id=120&Itemid=233'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/10-nashriat2.png">آرشیو نشریات</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a  href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=232'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/09-video.png">آموزش کلینیکال(بدون هزینه)</a></li>';
		...
		panel = panel + '<li class="even ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_myacademy&view=notificationqueues&Itemid=424'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r"  data-rel="external" data-ajax="false" ><img src="images/menu/01-news.png">طلاع رسانی</a></li>';
		panel = panel + '<li class="odd ui-li-has-thumb"><a href="#" onclick="openURL(' + "'http://apps.dparseh.ir/index.php?option=com_blankcomponent&view=default&Itemid=543'" + ',true,false);" class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#panel-responsive-page2"  data-rel="external" data-ajax="false" ><img src="images/menu/07-speedreplay.png">منابع آزمون ebook</a></li>';
...
// alert(text);
	...
	function getMENU() {	
		...
		if(window.sessionStorage.getItem('menu_json') == null)
		{
			...
			{
				$.ajax({ type: "GET",   
						url: "http://apps.dparseh.ir/?MobileMenu=135,137",
						async: true,
						success : function(text)
						{
							//alert(text);
